""" 
Plot the convergence as the number of time steps goes to 0 

The target domain D is the sphere 
"""
...
nameFileD = "face_vector_field_319.off"

# Paramter r for the saddle point problem  
r = 1.0
